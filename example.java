...
public class EvincedSeeTest {
    ...
    private static String accessKey = "SEETEST_ACCESS_KEY";
    ...
    public static void setupAppiumDriver() throws MalformedURLException, IOException {
        ...
        dc.setCapability("platformVersion", "15.0.1");
        dc.setCapability("deviceName", "auto");
        dc.setCapability(MobileCapabilityType.APP, "cloud:com.evinced.kevin543211.swift-radio");
        dc.setCapability(IOSMobileCapabilityType.BUNDLE_ID, "com.evinced.kevin543211.swift-radio");
